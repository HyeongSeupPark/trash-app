...
st.markdown("""
    ...
    *:not(.material-symbols-rounded):not([data-testid="stIconMaterial"]) { 
    ...
    .content-card { background-color: #ffffff !important; padding: 45px !important; border-radius: 35px !important; box-shadow: 0 20px 60px rgba(27, 94, 32, 0.1) !important; border: 1px solid #e8f5e9 !important; height: 100%; }

    /* =========================================
       📸 업로더 UI 완벽 개선 (직관적인 버튼화)
       ========================================= */
       
    /* 1. 기본 스트림릿 텍스트, 버튼, 아이콘 등 찌꺼기 완벽 숨김 */
    ...
    /* 3. 드롭존 자체를 하나의 거대하고 예쁜 버튼으로 디자인 */
